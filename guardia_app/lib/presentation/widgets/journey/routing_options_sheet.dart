      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: isSelected ? [
            BoxShadow(
              color: (isSafe ? AppColors.secondary : AppColors.primary).withValues(alpha: 0.1),
              blurRadius: 10,
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isSafe ? AppColors.secondary.withValues(alpha: 0.1) : Colors.grey[100],
            ...
            if (features != null) ...[
              ...
              Wrap(
                spacing: 8,
                runSpacing: 8,
                children: features.map(_buildFeatureTag).toList(),
              ),
            ]
          ],
        ),
